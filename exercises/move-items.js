...
for (const item of allItems) {
  item.addEventListener('click', () => {
    const currentCollection = item.parentElement.getAttribute('id');
    const itemId = item.getAttribute('id');
    const direction = currentCollection === 'main' ? 'toFavs' : 'toMain';
